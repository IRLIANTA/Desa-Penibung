...
@section('content')
    <div id="Content" class="relative flex flex-col flex-1 gap-6 p-6 pb-[30px] shrink-0">
        <div id="Header" class="flex items-center justify-between">
            <div class="flex flex-col gap-2">
                <div class="flex gap-1 items-center leading-5 text-desa-secondary">
                    ...
                    <span>/</span>
                    <p class="last-of-type:text-desa-dark-green last-of-type:font-semibold capitalize ">Ubah Pembangunan
                        Desa</p>
                </div>
                    ...
                    <div class="flex flex-1 gap-6 shrink-0">
                        <label
                            ...
                            <div class="flex size-6 shrink-0">
                                <img src="{{ asset('assets') }}/images/icons/wallet-check-dark-green.svg"
                        ...
                        <label
                            ...
                            <div class="flex size-6 shrink-0">
                                <img src="{{ asset('assets') }}/images/icons/wallet-remove-secondary-green.svg"
                                    class="size-6 flex group-has-[:checked]:hidden" alt="icon">
                                <img src="{{ asset('assets') }}/images/icons/wallet-remove-secondary-green.svg"
                                    class="size-6 hidden group-has-[:checked]:flex" alt="icon">
                            </div>
