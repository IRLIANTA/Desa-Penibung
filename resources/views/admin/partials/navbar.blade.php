<div id="Top-Bar" class="relative flex shrink-0">
  <div
    ...
    <form action="kd-search-result.html" class="flex w-full">
      <label
        class="group flex w-full items-center rounded-full border border-desa-background 
               py-2 sm:py-3 md:py-4 px-4 sm:px-6 gap-2 bg-white 
               hover:border-desa-dark-green focus-within:border-desa-dark-green transition-setup">
        <button type="submit" class="relative flex size-5 sm:size-6 shrink-0">
          <img src="{{ asset('assets/') }}/images/icons/search-normal-dark-green.svg"
            class="absolute flex size-full opacity-0 group-focus-within:opacity-100 transition-setup" alt="icon">
          <img src="{{ asset('assets/') }}/images/icons/search-normal-secondary-green.svg"
            class="absolute flex size-full opacity-100 group-focus-within:opacity-0 transition-setup" alt="icon">
        </button>
        <input type="text"
    ...
    @if(auth()->check())
      ...
      <a href="#"
        ...
        <img src="{{ asset('assets/') }}/images/icons/notification-secondary-green.svg" class="size-5 sm:size-6" alt="icon">
      </a>
      <a href="#"
        class="flex size-12 sm:size-14 shrink-0 items-center justify-center rounded-2xl border border-desa-background hover:border-desa-secondary transition-setup">
        <img src="{{ asset('assets/') }}/images/icons/setting-2-secondary-green.svg" class="size-5 sm:size-6" alt="icon">
      </a>

      <!-- User Profile -->
      <div class="flex items-center gap-3 sm:gap-4">
        <div class="flex size-10 sm:size-12 md:size-14 shrink-0 rounded-full overflow-hidden bg-desa-foreshadow">
