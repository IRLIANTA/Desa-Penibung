        ...
        <div class="fixed top-0 h-full w-[280px] flex shrink-0 flex-1 z-20 bg-white">
            <div class="flex flex-col h-full w-full gap-6 pt-[30px] px-6">
                <div class="flex items-center justify-between">
                    <img src="{{ asset('assets/') }}/images/logos/logo-text.svg" class="flex h-[30px] shrink-0"
                        alt="logo">
                    <button
                        ...
                        <ul>
                            <li class="group">
                                <a href="{{ route('social-assistance.index') }}"
                                    ...
                                    <span
                                        class="text-left leading-5 text-desa-secondary flex flex-1 hover:text-desa-dark-green transition-setup">
                                        Bantuan Sosial
                                    </span>
                                </a>
                            </li>
