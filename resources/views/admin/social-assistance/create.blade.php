...
@section('content')
    <div class="flex flex-col gap-3 p-4 sm:gap-3.5 md:p-6">
        <div id="Header" class="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div class="flex flex-col gap-2">
                <div class="flex items-center gap-1 text-sm leading-5 text-desa-secondary">
                    ...
                    <span>/</span>
                    <p class="capitalize last-of-type:font-semibold last-of-type:text-desa-dark-green">tambah bantuan sosial</p>
                </div>
                <h1 class="text-2xl font-semibold">Tambah Bantuan Sosial</h1>
            </div>
        </div>
        ...
        <form action="{{ route('social-assistance.store') }}" method="POST" enctype="multipart/form-data" id="myForm" class="capitalize">
            @csrf
            <div class="flex h-fit flex-col gap-6 rounded-3xl bg-white p-4 md:p-6">
                <section id="thumbnail" class="flex flex-col justify-between gap-4 md:flex-row">
                    ...
                    <div class="flex flex-1 flex-col items-center justify-between gap-4 sm:flex-row">
                        ...
                        <div class="relative w-full sm:w-auto">
                            <input required id="File" type="file" name="thumbnail" class="absolute left-0 top-0 h-full w-full opacity-0" />
                ...
                <section id="name" class="flex flex-col justify-between gap-2 md:flex-row md:items-center">
                    ...
                    <div class="flex flex-1 shrink-0 flex-col gap-3">
                        <label class="group peer relative w-full">
                            <input type="text" placeholder="Tentukan nama bantuan sosial" name="name" class="h-14 w-full appearance-none rounded-2xl py-4 pl-12 pr-4 font-medium placeholder:text-desa-secondary ring-[1.5px] ring-desa-background transition-all duration-300 focus:outline-none focus:ring-desa-black">
                ...
                <section id="category" class="flex flex-col justify-between gap-4 md:flex-row">
                    ...
                    <div class="grid flex-1 shrink-0 grid-cols-1 gap-4 sm:grid-cols-2">
                        <label class="group flex h-14 w-full cursor-pointer items-center gap-2 rounded-2xl p-4 ring-[1.5px] ring-desa-background transition-all duration-300 has-[:checked]:bg-desa-foreshadow has-[:checked]:ring-0">
                            <input type="radio" name="category" value="Bahan Pokok" class="size-[18px] shrink-0 accent-desa-secondary transition-all duration-300 checked:accent-desa-dark-green">
                        ...
                        <label class="group flex h-14 w-full cursor-pointer items-center gap-2 rounded-2xl p-4 ring-[1.5px] ring-desa-background transition-all duration-300 has-[:checked]:bg-desa-foreshadow has-[:checked]:ring-0">
                            <input type="radio" name="category" value="Uang Tunai" class="size-[18px] shrink-0 accent-desa-secondary transition-all duration-300 checked:accent-desa-dark-green">
                        ...
                        <label class="group flex h-14 w-full cursor-pointer items-center gap-2 rounded-2xl p-4 ring-[1.5px] ring-desa-background transition-all duration-300 has-[:checked]:bg-desa-foreshadow has-[:checked]:ring-0">
                            <input type="radio" name="category" value="BBM Subsidi" class="size-[18px] shrink-0 accent-desa-secondary transition-all duration-300 checked:accent-desa-dark-green">
                        ...
                        <label class="group flex h-14 w-full cursor-pointer items-center gap-2 rounded-2xl p-4 ring-[1.5px] ring-desa-background transition-all duration-300 has-[:checked]:bg-desa-foreshadow has-[:checked]:ring-0">
                            <input type="radio" name="category" value="Kesehatan" class="size-[18px] shrink-0 accent-desa-secondary transition-all duration-300 checked:accent-desa-dark-green">
                ...
                <section id="amount" class="flex flex-col justify-between gap-2 md:flex-row md:items-center">
                    ...
                    <div class="flex flex-1 shrink-0 flex-col gap-3">
                        <label class="group peer relative w-full">
                            <input type="text" name="amount" placeholder="Ketik nominal bantuan" class="h-14 w-full appearance-none rounded-2xl py-4 pl-12 pr-4 font-medium placeholder:text-desa-secondary ring-[1.5px] ring-desa-background transition-all duration-300 focus:outline-none focus:ring-desa-black">
                            <div class="absolute left-4 top-1/2 flex size-6 shrink-0 -translate-y-1/2">
                ...
                <section id="giver_name" class="flex flex-col justify-between gap-2 md:flex-row md:items-center">
                    ...
                    <div class="flex flex-1 shrink-0 flex-col gap-3">
                        <label class="group peer relative w-full">
                            <input type="text" placeholder="Ketik nama orang atau organisasi" name="giver_name" class="h-14 w-full appearance-none rounded-2xl py-4 pl-12 pr-4 font-medium placeholder:text-desa-secondary ring-[1.5px] ring-desa-background transition-all duration-300 focus:outline-none focus:ring-desa-black">
                            <div class="absolute left-4 top-1/2 flex size-6 shrink-0 -translate-y-1/2">
                ...
                <section id="Deskripsi" class="flex flex-col justify-between gap-4 md:flex-row">
                    ...
                    <div class="flex flex-1 shrink-0 flex-col gap-3">
                        <textarea name="description" id="description" placeholder="Jelaskan lebih detail tentang bantuan" rows="6" class="w-full appearance-none rounded-2xl p-4 font-medium placeholder:text-desa-secondary ring-[1.5px] ring-desa-background transition-all duration-300 focus:outline-none focus:ring-desa-black"></textarea>
                    </div>
                </section>
                <hr class="border-desa-background" />
                ...
                <section id="Ketersediaan" class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    ...
                    <div class="grid flex-1 grid-cols-1 gap-4 sm:flex-row sm:grid-cols-2">
                        <label class="group flex h-14 w-full cursor-pointer items-center gap-2 rounded-2xl p-4 ring-[1.5px] ring-desa-background transition-all duration-300 has-[:checked]:bg-desa-foreshadow has-[:checked]:ring-0">
                            <input type="radio" name="availability" value="Tersedia" class="size-[18px] shrink-0 accent-desa-secondary transition-all duration-300 checked:accent-desa-dark-green">
                        ...
                        <label class="group flex h-14 w-full cursor-pointer items-center gap-2 rounded-2xl p-4 ring-[1.5px] ring-desa-background transition-all duration-300 has-[:checked]:bg-desa-foreshadow has-[:checked]:ring-0">
                            <input type="radio" name="availability" value="Tidak Tersedia" class="size-[18px] shrink-0 accent-desa-secondary transition-all duration-300 checked:accent-desa-dark-green">
