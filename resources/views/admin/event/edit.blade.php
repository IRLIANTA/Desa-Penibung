...
@section('content')
    <div id="Content" class="relative flex flex-col flex-1 gap-6 p-6 pb-[30px] w-full shrink-0">
        ...
        <form action="{{ route('event.update') }}" method="POST" enctype="multipart/form-data" id="myForm" class="capitalize">
        @csrf
        ...
        <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
            ...
            <section class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <label class="relative group peer w-full">
                        <input name="name" type="text"  value="{{ $event->name }}" placeholder="Ketik nama event terkait"
            ...
            <section class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <input type="time" value="{{ $event->start_time }}" name="start_time" required
            ...
            <section class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <input name="partisipasi" value="{{ $event->partisipasi }}" type="number" placeholder="Masukkan jumlah warga"
            ...
            <section class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-6 flex-1 shrink-0">
                    <input type="date" name="date" value="{{ $event->date }}" id="date" required
                        class="appearance-none outline-none w-full h-14 rounded-2xl ring-[1.5px] ring-desa-background focus:ring-desa-black px-4 font-medium" />
                </div>
            </section>
