        ...
        <section id="Bantuan-Sosial" class="flex flex-col w-[calc(497/1000*100%)] shrink-0 rounded-2xl bg-white">
            <div class="flex flex-col gap-3 p-6">
                <div class="flex items-center justify-between">
                    ...
                    <img src="assets/images/icons/bag-2-foreshadow-background.svg" class="flex size-12 shrink-0"
                        alt="icon">
                </div>
                <div class="flex flex-col gap-[6px]">
            ...
            <div class="flex flex-col gap-4 p-6">
                ...
                <div class="hidden m-auto h-[384px] flex flex-col shrink-0 justify-center items-center gap-6">
                    <img src="assets/images/icons/bag-cross-secondary.svg" class="flex size-[52px] shrink-0"
                        alt="icon">
            ...
            <div id="Date-Picker" class="flex flex-col gap-4 p-6">
                <div class="flex items-center justify-between">
                    <button
                        ...
                        <img src="assets/images/icons/arrow-left-secondary-green.svg" class="flex size-6 shrink-0"
                            alt="icon">
                    </button>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1">
                            <img src="assets/images/icons/clock-white.svg" class="flex size-[18px] shrink-0"
                                alt="icon">
        ...
        <section id="Total-Aplicants" class="flex flex-col gap-[14px] w-[calc(603/1000*100%)]">
                ...
                <div class="flex flex-col gap-4 p-6">
                    ...
                    <div class="card flex items-center w-full gap-3">
                        <div class="flex size-[72px] shrink-0 rounded-2xl bg-desa-foreshadow overflow-hidden">
                            <img src="assets/images/thumbnails/kd-applicant-1.png" class="w-full h-full object-cover"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-[6px] w-full">
                    ...
                    <div class="card flex items-center w-full gap-3">
                        <div class="flex size-[72px] shrink-0 rounded-2xl bg-desa-foreshadow overflow-hidden">
                            <img src="assets/images/thumbnails/kd-applicant-2.png" class="w-full h-full object-cover"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-[6px] w-full">
                            <div class="flex items-center gap-[6px]">
                    ...
                    <div class="card flex items-center w-full gap-3">
                        <div class="flex size-[72px] shrink-0 rounded-2xl bg-desa-foreshadow overflow-hidden">
                            <img src="assets/images/thumbnails/kd-applicant-3.png" class="w-full h-full object-cover"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-[6px] w-full">
                            <div class="flex items-center gap-[6px]">
                    ...
                    <div class="hidden m-auto h-[280px] flex flex-col shrink-0 justify-center items-center gap-6">
                        <img src="assets/images/icons/note-remove-secondary.svg" class="flex size-[52px] shrink-0"
                            alt="icon">
                        <p class="font-medium leading-5 text-center text-desa-secondary">Ups, nampaknya belum ada Applicant
                        </p>
                    </div>
                </div>
            </div>
            <div class="flex items-center justify-between h-[125px] rounded-2xl p-8 gap-4 gradient-horizontal">
                ...
                <a href="#" class="flex items-center flex-nowrap rounded-2xl p-4 gap-[10px] bg-white">
                    ...
                    <img src="assets/images/icons/receive-square-dark-green.svg" class="flex size-6 shrink-0"
                        alt="icon">
                </a>
            </div>
        </section>
