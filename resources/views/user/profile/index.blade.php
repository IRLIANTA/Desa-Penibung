        ...
        <div class="flex gap-[14px]">
            <section id="Nama-Desa"
                ...
                <div class="flex items-center justify-between">
                    ...
                    <img src="{{ asset('/assets') }}/images/icons/building-foreshadow-background.svg" class="flex size-12 shrink-0"
                        alt="icon">
                </div>
                <div id="Nama-Desa" class="flex flex-col gap-[6px]">
                    <h1 class="font-bold text-[32px] leading-10">Desa Penibung</h1>
                    <div class="flex items-center gap-0.5">
                        <img src="{{ asset('/assets') }}/images/icons/location-secondary-green.svg" class="flex size-6 shrink-0"
                            alt="icon">
                ...
                <div id="Gallery" class="flex flex-col gap-[14px]">
                    <div data-modal="Modal-Gallery" data-gallery="{{ asset('/assets') }}/images/thumbnails/desa-gallery-1.png"
                        id="Thumbnail-Desa"
                ...
                <div class="flex flex-col gap-[14px]">
                    ...
                    <div class="flex items-center gap-3 w-[302px] shrink-0">
                        <div
                            ...
                            <img src="{{ asset('/assets') }}/images/icons/profile-2user-dark-green.svg" class="flex size-6 shrink-0"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-3 w-[302px] shrink-0">
                        <div
                            class="flex size-[52px] rounded-2xl items-center justify-center bg-desa-foreshadow overflow-hidden">
                            <img src="{{ asset('/assets') }}/images/icons/tree-dark-green.svg" class="flex size-6 shrink-0"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-3 w-[302px] shrink-0">
                        <div
                            class="flex size-[52px] rounded-2xl items-center justify-center bg-desa-foreshadow overflow-hidden">
                            <img src="{{ asset('/assets') }}/images/icons/grid-5-dark-green.svg" class="flex size-6 shrink-0"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-1">
