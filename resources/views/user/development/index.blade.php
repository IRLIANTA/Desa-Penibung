                ...
                <div class="flex flex-col gap-3 w-[370px] shrink-0">
                    <label class="relative group peer w-full valid">
                        ...
                        <div class="absolute transform -translate-y-1/2 top-1/2 left-4 flex size-6 shrink-0">
                            <img src="{{ asset('/assets') }}/images/icons/box-search-secondary-green.svg"
                                class="size-6 hidden group-has-[:placeholder-shown]:flex" alt="icon">
                            <img src="{{ asset('/assets') }}/images/icons/box-search-black.svg"
                ...
                <div class="flex items-center w-full">
                    ...
                    <div class="flex flex-col gap-[6px] w-full ml-4 mr-9">
                        ...
                        <div class="flex items-center gap-1">
                            <img src="{{ asset('/assets') }}/images/icons/user-square-secondary-green.svg" class="flex size-[18px] shrink-0"
                                alt="icon">
